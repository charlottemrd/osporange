            ...
            if ($request->isXmlHttpRequest()) {
                ...
                if ($type == 1) {
                    ...
                    foreach ($projets as $po) {
                        ...
                        $couttotal = coutprojet($po->getProjet());
                        ...
                        if ($existbilan) {//on reprend ce bilan
                            ...
                            for ($a = 0; $a < sizeof($bilanajouter, COUNT_NORMAL); $a++) {
                                ...
                                foreach ($pk->getFournisseur()->getProfils() as $ps) {
                                    ...
                                    $sxz = proposeTGIM($infobilanRepository, $coutRepository, $existbilan, $ps, $pk, $mth);
                            ...
                            for ($af = 0; $af < sizeof($bilanajouter, COUNT_NORMAL); $af++) {
                                ...
                                foreach ($pkt->getFournisseur()->getProfils() as $pst) {
                                    ...
                                    $sxz = proposeTGIM($infobilanRepository, $coutRepository, $newonebilan, $pst, $pkt, $mtht);
...
function proposeTGIM(InfobilanRepository $infobilanRepository, CoutRepository $coutRepository, Idmonthbm $idmonthbm,Profil $profil, Projet $projet,$mois){
